...
Search for SQLi mitigation and discuss next time.

### Part 2: Labs

#### Portswigger Labs (mandatory)
...
### YesWeHack Dojo (optional - good to solve)

https://dojo-yeswehack.com/learn/vulnerabilities/sqli

### picoCTF challenges (optional)
